...
export default function ConnectionStatus() {
  ...
  if (status === 'connected') {
    return (
      <div className="flex items-center space-x-1.5 px-2.5 py-1 bg-green-500/10 border border-green-500/20 rounded-full animate-fade-in">
  ...
  if (status === 'connecting') {
    return (
      <div className="flex items-center space-x-1.5 px-2.5 py-1 bg-yellow-500/10 border border-yellow-500/20 rounded-full animate-pulse">
  ...
  return (
    <div className="flex items-center space-x-1.5 px-2.5 py-1 bg-red-500/10 border border-red-500/20 rounded-full animate-fade-in">
